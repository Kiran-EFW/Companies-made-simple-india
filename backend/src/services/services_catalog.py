...
COMPANY_ENTITIES = ["private_limited", "opc", "section_8", "public_limited"]
MCA_ENTITIES = ["private_limited", "opc", "llp", "section_8", "public_limited"]
...
SUBSCRIPTION_PLANS: List[Dict[str, Any]] = [
    ...
    {
        "key": "compliance_enterprise",
        "name": "Enterprise",
        "target": "Public Limited & Section 8",
        "monthly_price": 9999,
        "annual_price": 99999,
        "entity_types": ["public_limited", "section_8"],
        "highlighted": False,
        "features": [
    ...
    {
        "key": "compliance_peace_of_mind",
        "name": "Peace of Mind",
        "target": "All Entity Types — Total Compliance Coverage",
        "monthly_price": 9999,
        "annual_price": 99999,
        "entity_types": ALL_ENTITY_TYPES,
        "highlighted": False,
        "is_peace_of_mind": True,
        "features": [
            "All ROC / MCA annual filings (AOC-4, MGT-7, Form 8, Form 11)",
            "Income Tax Return filing",
            ...
            "Statutory audit coordination",
            "Board meeting documentation (4/year)",
            "INC-20A commencement filing (if applicable)",
            "MSME / Udyam registration included",
            "2 free event-based filings per year (director changes, share transfers, office changes)",
            "Zoho Books / Tally integration for auto-filing",
            "Compliance autopilot — automated deadline tracking",
            "Tax planning advisory (quarterly)",
            "Penalty protection — up to Rs 25,000/yr in service credits",
            "Same-day response SLA",
            "Quarterly compliance health reports",
            "Dedicated CA + CS + relationship manager",
        ],
        "not_included_note": "Bookkeeping, payroll, and trademark available as add-ons",
    },
]
