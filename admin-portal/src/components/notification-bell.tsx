...
function getNotificationColor(type: string): string {
  switch (type) {
    ...
    case "document": return "var(--color-accent-purple)";
    case "compliance": return "var(--color-warning)";
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      <p
                        ...
                        style={{ color: !notif.is_read ? "var(--color-text-primary)" : "var(--color-text-secondary)" }}
                      >
                        {notif.title}
                      </p>
                      {!notif.is_read && (
