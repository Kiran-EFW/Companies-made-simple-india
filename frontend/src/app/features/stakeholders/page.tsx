...
const FEATURES = [
  ...
  { icon: <Building2 className="w-5 h-5" />, title: "Auditor & CA Tracking", desc: "Maintain auditor appointment details, tenure tracking, and direct collaboration with your CA." },
